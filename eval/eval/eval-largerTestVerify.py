...
def start_test(train_data, test_data, mask, epoch=16, model_name="microsoft/deberta-v3-large"):
    seed = 42
    ...
    training_args = TrainingArguments(
        ...
        per_device_train_batch_size=1,  # Setting batch size to 1
        gradient_accumulation_steps=16,  # Accumulate gradients over 16 steps before performing backpropagation
