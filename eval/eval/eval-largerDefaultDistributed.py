...
def start_test(train_data, test_data, model_name="microsoft/deberta-v3-large"):
    # Hyperparameters
    learning_rate = 1e-06
    train_batch_size = 16
    eval_batch_size = 16
...
if __name__ == "__main__":
    ...
    logs, accs, class_accuracies = test_thresholds(filenames, test_file_location, model_name="microsoft/deberta-v3-large")
    ...
    plt.tight_layout()
    plt.show()
    plt.savefig(f"../imgs/analyze/paper_fig/{dataset}_deberta_v3_large_analyze.png")
