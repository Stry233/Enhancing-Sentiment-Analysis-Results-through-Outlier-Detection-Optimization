...
################################################################################
@click.command()
@click.argument('dataset_name', type=click.Choice(['mnist', 'cifar10', 'twitter', 'savee',
                                                   'mteb_counterfactual', 'mteb_imdb', 'mteb_toxic',
                                                   'mteb_tweet_sentiment', 'mteb_emotion', 'hate_speech18', 'sst2',
                                                   'yelp_polarity', 'mteb_reviews', 'C4_sentiment-analysis']))
@click.argument('net_name', type=click.Choice(['mnist_LeNet', 'cifar10_LeNet', 'cifar10_LeNet_ELU', 'cifar10_ResNet',
                                               'text_Transformer', 'text_ResNet', 'savee_LeNet', 'text_LSTM',
                                               'savee_TIMNet']))
